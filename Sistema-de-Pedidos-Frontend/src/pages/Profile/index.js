        ...
        <Home name={'Perfil'}>
            <div className='containerProcfile'>
                ...
                <div className='changeProcfile'>
                    <span>Enviar imagen de perfil</span>
                    <button onClick={() => setCamera(!camera)}>Camara</button>
                    <button onClick={() => setPhoto(!photo)}>Archivo</button>
                </div>
                                    ...
                                    (
                                        <>
                                            <button
                                                ...
                                                onClick={() => setTakePicture(!takePicture)}>Toma otra foto</button>
                                            <button
                                                className='savePicture'
                                                onClick={() => savePhoto()}>Guardar foto</button>
                                        </>
                                    )}
                            </div>
                        </div>
